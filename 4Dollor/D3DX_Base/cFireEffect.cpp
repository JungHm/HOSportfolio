...
void cFireEffect::Render()
{
	...
	g_pD3DDevice->SetRenderState(D3DRS_POINTSCALE_A, eFtoDW(0.0f));
	g_pD3DDevice->SetRenderState(D3DRS_POINTSCALE_B, eFtoDW(0.0f));
	g_pD3DDevice->SetRenderState(D3DRS_POINTSCALE_C, eFtoDW(1.0f));

	g_pD3DDevice->SetRenderState(D3DRS_POINTSPRITEENABLE, true);
	g_pD3DDevice->SetRenderState(D3DRS_POINTSIZE_MIN, eFtoDW(0.0f));
	g_pD3DDevice->SetRenderState(D3DRS_POINTSIZE_MAX, eFtoDW(100.0f));
	...
	for (int i = 0; i < m_vecEffect.size(); i++)
	{
		...
		{
			// 포인트 사이즈 설정
			g_pD3DDevice->SetRenderState(D3DRS_POINTSIZE, eFtoDW(10.0f));
		...
		{
			// 포인트 사이즈 설정
			g_pD3DDevice->SetRenderState(D3DRS_POINTSIZE, eFtoDW(25.0f));
