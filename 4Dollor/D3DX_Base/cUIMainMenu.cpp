...
void cUIMainMenu::renderOther()
{
	...
	{
		LPD3DXFONT m_Font = g_pFontManager->GetFont(cFontManager::FT_SMALL);
		m_Font->DrawTextA(NULL, p.str.c_str(), -1, &p.rcText, DT_CENTER | DT_VCENTER, D3DCOLOR_ARGB(p.alpha, 255, 255, 255));
	}
}
